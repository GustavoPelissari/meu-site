      ...
      <div class="container contact__grid">
        <div class="contact__copy reveal">
          ...
          <p class="section__subtitle">
            Conte-me o que você quer construir. Eu retorno com visão de produto, direção visual e um caminho técnico objetivo para o seu próximo site.
          </p>
          <a
            class="button button--ghost contact__whatsapp"
            href="https://wa.me/5551996255682?text=Olá%2C%20Gustavo.%20Quero%20iniciar%20meu%20projeto."
            target="_blank"
            rel="noreferrer"
          >
            Chamar no WhatsApp
        ...
        <div class="contact__panel reveal">
          <form class="form" data-contact-form>
            ...
            <div class="form__field">
              ...
              <input class="form__input" id="project" name="project" type="text" placeholder="Site institucional, landing page, portal comunitário..." />
            </div>

            <div class="form__field">
              <label class="form__label" for="budget">Orçamento estimado</label>
            ...
            <div class="form__field">
              ...
              <textarea class="form__textarea" id="message" name="message" placeholder="Conte seu objetivo, seu prazo e o que você imagina para o projeto."></textarea>
            </div>
            ...
            <div class="form__actions">
              ...
              <span class="form__note">Resposta com direção clara, proposta objetiva e próximo passo definido.</span>
            </div>
          </form>
        </div>
      </div>
